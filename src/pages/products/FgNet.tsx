...
function AlarmsUnit() {
  return (
    <div className="flex flex-col gap-4 p-8">
      ...
      <div className="_CONTENT flex gap-8">
        <div className="_LEFT_SECTION flex min-w-[400px] flex-col gap-4">
          ...
          <div className="flex flex-col">
            <img
              ...
              src={data.alarmUnits[0].image}
              alt=""
            />
            <div className="w-fit text-center text-blue-datatech">
              <h1 className="text-2xl font-semibold">
                {data.alarmUnits[0].type}
              </h1>
              <h3 className="text-xl font-medium">{data.alarmUnits[0].name}</h3>
            </div>
            <table className="mt-8 w-full table-auto">
              <thead>
                <tr className="bg-blue-datatech text-[#00D8F5]">
                  <th
                    colSpan={2}
                    className="border-2 border-blue-datatech px-4 py-2 text-left font-normal"
                  >
                    DOWNLOAD
                  </th>
                </tr>
              ...
              <tbody className="bg-white">
                <tr>
                  <td className="w-1/2 border-2 border-black px-4 py-2 "></td>
                  <td className="w-1/2 border-2 border-black px-4 py-2 text-center text-blue-datatech">
                    DOWNLOAD
                  </td>
                </tr>
                <tr>
        ...
        <div className="_RIGHT_SECTION w-full text-blue-datatech">
          <p className="mt-8 font-medium">{data.alarmUnits[0].description}</p>
          <p className="mt-8 font-medium">{data.alarmUnits[0].description}</p>
        </div>
      </div>
    </div>
